...
lyr_satellitemaps_0.setVisible(true);lyr_Prj_AREA_1.setVisible(true);lyr_Cadastral_2.setVisible(true);lyr_polyline_FCAD_3.setVisible(false);lyr_Parcel_No_4.setVisible(true);
