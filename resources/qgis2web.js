...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [5626500.451724, 3016437.800264, 5630351.497753, 3018829.846602], maxZoom: 20, minZoom: 2
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([5626500.451724, 3016437.800264, 5630351.497753, 3018829.846602], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Cadastral_2,
    colName: 'BSI_str',
    zoom: 10,  // Adjust this value to your desired zoom level (e.g., 15 instead of 25)
    collapsed: true,
    map: map
});
...
document.getElementsByClassName('search-layer-input-search')[0].placeholder = 'Parcel Number...';
